...
interface EditApplicationModalProps {
  isOpen: boolean;
  onClose: () => void;
  selectedApp: Partial<RecruiterApplicationItem>;
  setSelectedApp: React.Dispatch<
    React.SetStateAction<Partial<RecruiterApplicationItem>>
  >;
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={e =>
                  setSelectedApp(p => ({ ...p, jobTitle: e.target.value }))
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={e =>
                  setSelectedApp(p => ({ ...p, companyName: e.target.value }))
                }
                className="w-full rounded-xl border border-[#ECE3DA] p-2.5 text-sm focus:ring-2 focus:ring-[#8F3E13] focus:outline-none"
              />
            </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={e =>
                setSelectedApp(p => ({ ...p, description: e.target.value }))
              }
              className="w-full rounded-xl border border-[#ECE3DA] p-2.5 text-sm focus:ring-2 focus:ring-[#8F3E13] focus:outline-none"
            />
          </div>
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <div>
              ...
              <input
                type="number"
                value={selectedApp.experienceRequired ?? ""}
                onChange={e =>
                  setSelectedApp(p => ({
                    ...p,
          ...
          <div className="grid grid-cols-3 gap-2">
            ...
            <div>
              ...
              <select
                value={selectedApp.payPeriod || "yearly"}
                onChange={e =>
                  setSelectedApp(p => ({
                    ...p,
