...
import { BriefcaseBusiness, MapPin, Phone, User } from "lucide-react";
import { useRouter } from "next/navigation";
import { WorkerApplicationContentProps } from "../types";
          ...
          <>
            {applications.map(app => (
              <div
                ...
                onClick={() =>
                  router.push(
                    `/applications/recruiters/${app.workerId}/${app.id}`
                  )
                }
