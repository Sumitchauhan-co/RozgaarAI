  ...
  return (
    <section className="relative overflow-hidden bg-[#FCFBF9]">
      ...
      <Image
        ...
        height={1000}
        priority
        className="pointer-events-none absolute top-0 left-1/2 w-full -translate-x-1/2 opacity-60 select-none"
      />

      {/* Soft premium glow (enhanced only) */}
      <div className="absolute -top-40 -left-40 h-[600px] w-[600px] rounded-full bg-[#F6C98F] opacity-35 blur-[140px]" />
      <div className="absolute top-0 right-0 h-[500px] w-[500px] rounded-full bg-[#F2D9C4] opacity-35 blur-[120px]" />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-10">
        <div className="grid items-center gap-16 py-24 lg:grid-cols-2 lg:py-28">
          ...
          <div>
            ...
            <div className="mt-10 space-y-4">
              ...
              <p className="text-sm text-[#6D645F]">
                Trusted by <span className="font-semibold">25,000+</span>{" "}
                workers & employers across India.
              </p>
          ...
          <div className="relative flex items-center justify-center">
            ...
            <div className="absolute h-[700px] w-[700px] rounded-full bg-[#F6C98F] opacity-25 blur-[120px]" />
            <div className="absolute h-[600px] w-[600px] rounded-full bg-[#F5DFC8] opacity-35 blur-[100px]" />
            ...
            {/* Active Jobs */}
            <div className="absolute top-12 left-0 z-20 rounded-3xl border border-white/60 bg-white/85 p-6 shadow-[0_20px_50px_rgba(91,30,5,0.12)] backdrop-blur-md transition hover:-translate-y-2">
            ...
            {/* AI Match */}
            <div className="absolute top-10 right-0 z-20 rounded-3xl border border-white/60 bg-white/85 p-6 shadow-[0_20px_50px_rgba(91,30,5,0.12)] backdrop-blur-md transition hover:-translate-y-2">
            ...
            {/* Verified */}
            <div className="absolute right-4 bottom-10 z-20 flex items-center gap-4 rounded-3xl border border-white/60 bg-white/85 p-6 shadow-[0_20px_50px_rgba(91,30,5,0.12)] backdrop-blur-md transition hover:-translate-y-2">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#F5E8DC] shadow-sm">
